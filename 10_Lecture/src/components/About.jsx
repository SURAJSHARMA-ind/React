...
export default function About() {
  return (
    <div className="relative isolate overflow-hidden bg-purple-600 bg-gradient-to-r from-teal-400 to-blue-500 py-24 sm:py-32">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">About shopEase</h2>
