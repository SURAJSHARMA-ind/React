  ...
  return (
    <>
      ...
      <div className='min-h-screen bg-black font-Roboto '>
        ...
        {todos.length !== 0 &&
          <select onChange={todoStatusHandler} className='ml-10 p-2 rounded bg-blue-950 text-white' name="todos" >
        ...
        {todos.map((item) => {
          return <div key={uid()} className="todocontainer mt-4 ml-8 w-1/2 text-white flex justify-between ">
            <div className="todoScontainer gap-4 flex ">
              ...
              <div className={` h-full bg-white  text-black mx-2 rounded-lg p-5 ${item.iscomplete ? "line-through" : ""}`}>{item.todo}</div>
            </div>
